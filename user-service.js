...
// helper function to get user using password authentications of the token payload
module.exports.findUserByUsernameAndId = function (userName, userId) {
  return new Promise(function (resolve, reject) {
    User.findOne({ userName: userName, _id: userId })
      .exec()
      .then((user) => {
        resolve(user);
      })
